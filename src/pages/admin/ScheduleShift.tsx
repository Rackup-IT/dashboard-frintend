...
export default function ScheduleShift() {
  ...
  useEffect(() => {
    if (dealerId) {
      apiRequest("GET", `dealer/get-single/${dealerId}`).then((data) => {
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <h2 className="text-lg font-semibold" data-testid="text-section-title">
          Schedule & Shift - {dealer.dealerName}
        </h2>
      </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-6 gap-4 items-end">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="day"
                    value={
                      scheduleDate ? format(scheduleDate, "MM/dd/yyyy") : ""
                    }
                    readOnly
                ...
                <div className="space-y-2">
                  <Label htmlFor="lastAppointmentTime" className="text-sm">
                    Last Appointment Time
                  </Label>
                  <Input
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setNoLastAppointment(checked as boolean)
                    }
                    data-testid="checkbox-no-last-appointment"
                  />
                  <Label
                    htmlFor="noLastAppointment"
