          ...
          <CardContent className="p-6">
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="password-confirmation" className="text-sm">Password Confirmation</Label>
                  <Input 
                ...
                <div className="space-y-2">
                  <Label htmlFor="ringcentral-user-id" className="text-sm">Ringcentral User Id</Label>
                  <Input 
